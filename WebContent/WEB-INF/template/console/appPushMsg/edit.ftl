...
<title>${message("console.appPushMsg.edit")} - 爱柚米 • 移动营销平台</title>
	  ...
	  <!-- start  导航 -->
	   ...
	   <div id="page-wrapper" class="gray-bg dashbard-1">
	       ...
	       <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2> ${message("console.appPushMsg.edit")}</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="${base}/console/common/index.ct">${message("console.path.index")}</a>
                        </li>
                        <li>
                            <strong>${message("console.appPushMsg.edit")}</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
	        ...
	        <div class="wrapper wrapper-content animated fadeIn">
				<!-- start 新增新闻-->
             	...
             	<input type="hidden" name="id" value="${appPushMsg.id}" />
         		<input type="hidden" name="createDate" value="${appPushMsg.createDate}" />
             	<div class="row">
                	<div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                     <table class="table table-striped">
                                     	<tr>
											...
											<td>
												<div class="row">
													...
													<div class="col-md-4">
														<input type="checkbox" id="isAllClass" name="isAllClass" value="true" class="i-checks" [#if dictClasses?size>0 && dictClasses?size==linkClasses?size]checked[/#if]/>
										...
										<tr>
											...
											<td>
												<input type="text" name="title" class="form-control" maxlength="64" value="${appPushMsg.title}"/>
											</td>
										</tr>
										<tr>
											<th>
											...
											<td>
												<input type="text" name="author"  class="form-control" maxlength="8" value="${appPushMsg.author}"/>
											</td>
											</tr>
										<tr>
											<th>
											...
											<td>
												...
												<div class="itemList-upload">
													<div class="imgShowBox">
													    [#if appPushMsg.coverImage??]
													        <img src="${appPushMsg.coverImage}" alt="上传新闻预览图" id="smallIconfilePreview" class="newsPreview" />
													    [#else]
													        <img src="${base}/resources/console/images/newsUploadt.png" alt="上传新闻预览图" id="smallIconfilePreview" class="newsPreview" />
													    [/#if]
														<a href="javascript:;" title="删除图片" [#if appPushMsg.coverImage??] style="display:inline-block"[/#if] class="delImg" id="delSmallIconfileImg">×</a>
													</div>
													<div class="uploadContainer" style="margin-left: 7px;">
														<input type="file" id="smallIconfileImageUpload" />
														<input type="hidden" id="smallIconfile" name="coverImage" value="${appPushMsg.coverImage}">
													</div>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td style="text-align: left;">
												...
												<textarea name="msgBody" id="editor" class="form-control">${appPushMsg.msgBody}</textarea>
											</td>
										</tr>
										<tr>
											<th>
											...
											<td>
												...
												<textarea name="digest" class="form-control">${appPushMsg.digest}</textarea>
											</td>
										</tr>
										<tr>
											<th>
											...
											<td>
												<label>
													<input type="checkbox" name="isDraft" value="true" class="i-checks" [#if appPushMsg.isDraft == true]checked[/#if] />
										...
										<tr>
											...
											<td>
												<input type="text" name="sourceUrl" class="form-control" maxlength="255" value="${appPushMsg.sourceUrl}"/>
											</td>
										</tr>
									</table>
									<table class="input">
