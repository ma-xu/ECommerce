...
<title>${message("console.attendanceEquipment.add")} - 爱柚米 • 移动营销平台</title>
	                                ...
	                                <div class="table-responsive">
	                                     <table id="listTable" class="table table-striped">
											...
											<tr>
												...
												<td>
													<input type="text" name="maintainer" class="form-control"  />
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="maintainerPhone" class="form-control"  />
												</td>
											</tr>
											<!--<tr>
												<th>
