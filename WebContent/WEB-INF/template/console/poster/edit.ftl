...
<title>${message("console.poster.edit")} - 爱柚米 • 移动营销平台</title>
	       ...
	       <!-- end 头部面包屑区域 -->
	        ...
	        <div class="wrapper wrapper-content animated fadeIn">
	             ...
	             <form id="inputForm" action="update.ct" method="post">
	             	...
	             	<input type="hidden" name="viewCount" value="${poster.viewCount}">
		             <div class="row">
	                    <div class="col-lg-12">
	                                ...
	                                <div class="table-responsive">
	                                     <table class="table table-striped">
											...
											<tr id="posterUrlTr" style="display:none">
												...
												<td>
													<input name="url" id="siteURL" class="form-control" value="${poster.url}"/>
											    </td>
											</tr>
										</table>
										<table class="input">
