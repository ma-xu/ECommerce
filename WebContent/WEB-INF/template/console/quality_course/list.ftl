...
<title>${message("console.qualityCourse.list")} - 爱柚米 • 移动营销平台</title>
													...
													<tr>
														...
														<td>
															<div style=";white-space:normal;height:auto;" class="datagrid-cell datagrid-cell-c1-item">
																<div class="contBox">	
																<p class="cont-tit">${qualityCourse.url} ${qualityCourse.description}<span>【${qualityCourse.createDate}】</span></p>	
