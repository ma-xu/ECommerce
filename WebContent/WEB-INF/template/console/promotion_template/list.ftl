        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>${message("console.promotionTemplate.list")}</h2>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li>
                                <strong>
                                    ${message("console.promotionTemplate.list")}
                                </strong>
                            </li>
                        </ol>
                    </div>
	                            ...
	                            <div class="ibox-content">
	                                <div class="row">
	                                    <div class="col-sm-6 m-b-xs">
		                                    <div class="btn-group">
		                                       	[@shiro.hasPermission name = "console:addPromotionTemplate"]
		                                        <a href="add.ct" class="btn btn-primary">
													<span class="addIcon">&nbsp;</span>${message("console.common.add")}
												</a>
											   	[/@shiro.hasPermission]
		                                        [@shiro.hasPermission name = "console:deletePromotionTemplate"]
	                                     ...
	                                     <div class="table-responsive">
		                                     <table id="listTable" class="table table-striped">
													<tr>
														...
														<th>
														    <span>${message("PormotionTemplate.name")}</span>
														</th>
														<th>
														    <span>${message("PormotionTemplate.templatePath")}</span>
														</th>
														<th>
														    <span>${message("PormotionTemplate.Description")}</span>
														</th>
														<th>
															<span>${message("console.common.handle")}</span>
														</th>
													</tr>
													[#list page.content as pormotionTemplate]
														<tr>
															<td>
																<input type="checkbox" name="ids" value="${pormotionTemplate.id}" />
															</td>
															<td>
																${pormotionTemplate.name}
															</td>
															<td>
															    ${pormotionTemplate.templatePath}
															</td>
															<td>
															    ${pormotionTemplate.description}
															</td>
															<td>
															[@shiro.hasPermission name = "console:editPromotionTemplate"]
																<a href="edit.ct?id=${pormotionTemplate.id}">[${message("console.common.edit")}]</a>
															[/@shiro.hasPermission]
															</td>
														</tr>
													[/#list]
