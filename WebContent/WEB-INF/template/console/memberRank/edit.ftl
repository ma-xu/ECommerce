...
<title>${message("console.memberRank.edit")} - 爱柚米 • 移动营销平台</title>
	...
	$inputForm.validate({
		rules: {
			name: {
				required: true,
				remote: {
					url: "check_name.ct?previousName=${memberRank.name?url}",
					cache: false
				},
				maxlength:100
			},
   ...
   <div id="wrapper">
	    ...
	    <div id="page-wrapper" class="gray-bg dashbard-1">
	        ...
	        <div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					<h2> ${message("console.memberRank.edit")} </h2>
	                <ol class="breadcrumb">
						<li>
						    <!--首页-->
	                    ...
	                    <li>
	                        <strong>${message("console.memberRank.edit")}</strong>
	                    </li>
					</ol>
	            </div>
	            <div class="col-lg-2">
			                ...
			                <div class="ibox-content" style="width:50%;margin:0 auto;">
			                    <form id="inputForm" action="update.ct" method="post" class="form-horizontal m-t">
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-sm-8">
			                                <input id="name" name="name" class="form-control" autocomplete="off" value="${memberRank.name}">
			                            </div>
			                        </div>
			                        <!--<div class="form-group">
			                            <label class="col-sm-3 control-label">${message("MemberRank.scale")}：</label>
			                            <div class="col-sm-8">
			                                <input id="scale" name="scale" class="form-control" autocomplete="off" value="${memberRank.scale}">
			                            </div>
			                        </div>-->
			                        <div class="form-group">
			                            <label class="col-sm-3 control-label"><span class="requiredField">*</span>${message("MemberRank.point")}：</label>
			                            <div class="col-sm-8">
			                                <input id="point" name="point" class="form-control" autocomplete="off" value="${memberRank.point}">
			                            </div>
			                        </div>
			                        <div class="form-group">
			                        	...
			                        	<div class="col-sm-8" style="padding-top:7px;">
			                        		<label>
												<input type="checkbox" name="isDefault" [#if memberRank.isDefault]checked="checked"[/#if]/>${message("MemberRank.isDefault")}
												<input type="hidden" name="_isDefault" value="${memberRank.isDefault?string('true','false')}"/>
											</label>
										</div>
									</div>
			                        <div class="form-group">
										...
										<div class="col-sm-8">
											...
											<img src="${memberRank.rankIcon}" style="display: none;" height="150px" id="showColumnCoverImage" />
											...
											<input type="hidden" id="columnCoverImage" name="rankIcon" class="form-control" value="${memberRank.rankIcon}"/>
										</div>
									</div>
			                        <div class="form-group">
