...
<title>${message("console.dictStudent.add")} - 爱柚米 • 移动营销平台</title>
...
$().ready(function() {
	...
	$("#addMemberBtn").click(function(){
	  countMember++;
	  var memberListHTML = '<table class="table table-bordered" style="width:50%;max-width:50%;margin:auto;display:inline-table;margin-bottom:14px;">'
							     +'<tr>'
