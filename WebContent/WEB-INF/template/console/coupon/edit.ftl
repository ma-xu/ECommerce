...
$().ready(function() {
	...
	$("#addMemberBtn").click(function(){
	  ...
	  var memberListHTML = '<tr>'
								+'<th>${message("规则")}：</th>'
								+'<td>'
								   +'<input type="text"  class="form-control" maxlength="200" name="content"/>'
								+'</td>'
						   +'</tr>';     
                                    ...
                                    <div id="settingBaseTab" class="tab-pane active">
                                        <table class="table table-striped">
												...
												<td>
													<select name="promotionTemplateId" class="form-control m-b">
														 ...
														 [#list promotionTemplate as promotionTemplate]
															<option value="${promotionTemplate.id}" [#if coupon.promotionTemplate.id == promotionTemplate.id] selected="selected" [/#if]>
											...
											<tr>
												...
												<td>
													<textarea name="introduction" class="form-control" style="height: 80px;" >${coupon.introduction}</textarea>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="text" name="action" class="form-control" value="${coupon.action}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<div class="itemList-upload">
														<div class="imgShowBox">
															[#if coupon.couponConver??]
														        <img src="${coupon.couponConver}"  id="smallIconfilePreview" class="newsPreview" />
														    [#else]
														        <img src="${base}/resources/console/images/newsUploadt.png" alt="上传海报图" id="smallIconfilePreview" class="newsPreview" />
														    [/#if]
														</div>
														<div class="uploadContainer" style="margin-left: 7px;">
															<input type="file" id="smallIconfileImageUpload" />
															<input type="hidden" id="smallIconfile" name="couponConver" value="${coupon.couponConver}"/>
														</div>
													</div>
											...
											<tr>
												...
												<td>
													 <div class="col-sm-8" style="padding-left:0px">
			                                			<input id="beginDate" name="beginDate" class="laydate-icon form-control layer-date" value="${coupon.beginDate?string("yyyy-MM-dd HH:mm:ss")}">
			                           				 </div>
												</td>
											</tr>
											<tr>
												...
												<td>
													 <div class="col-sm-8" style="padding-left:0px">
			                                			<input id="endDate" name="endDate" class="laydate-icon form-control layer-date" value="${coupon.endDate?string("yyyy-MM-dd HH:mm:ss")}"/>
			                           				 </div>
												</td>
											</tr>
											<tr>
												...
												<td>
			                                		<input type="text" name="priceExpression" class="form-control" value="${coupon.priceExpression}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
			                                		<input type="text" name="couponPrice" class="form-control" value="${coupon.couponPrice}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
			                                		<input type="text" name="point" class="form-control"  value="${coupon.point}"/>
												</td>
											</tr>
											<tr>
												<th>
													${message("Coupon.circulation")}:
												</th>
												<td>
			                                		<input type="text" name="circulation" class="form-control"  value="${coupon.circulation}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
			                                		<input type="text" name="limited" class="form-control" value="${coupon.limited}"/>
												</td>
											</tr>
											<tr>
												<th>
												...
												<td>
													<input type="checkbox" name="isEnabled" id="isEnabled" [#if coupon.isEnabled == true] checked [/#if]/>
													<lable for="isEnabled">${message("Coupon.isEnabled")}</lable>
													<input type="checkbox" name="isExchange" style="margin-left:38px;" [#if coupon.isExchange == true] checked [/#if]/>
                                    ...
                                    <div id="settingRegisterSecurityTab" class="tab-pane">
                                        <table class="table table-striped">
											...
											<table class="table table-striped" id="addStuMember">
											    [#list couponRules as couponRules]
												 <tr>
													 <th>${message("规则")}：</th>
													 <td>	
								  						 <input type="text"  class="form-control" name="content" maxlength="200" value="${couponRules}"/>
													 </td>
						   						 </tr> 
						   						 [/#list]
											</table>
